  ...
  <v-container fluid>
    <v-list subheader two-line>
      ...
      <v-list-item three-line>
        <v-list-item-avatar tile size="80" class="rounded-circle" color="grey">
        ...
        <v-list-item-content>
          ...
          <v-list-item-subtitle>{{ userProfile.gender }}</v-list-item-subtitle>
        </v-list-item-content>
        <v-list-item-action>
      ...
      <v-list-item>
        ...
        <v-list-item-content>
          ...
          <v-list-item-subtitle>{{ userProfile.bodyFat }}</v-list-item-subtitle>
        </v-list-item-content>
        <v-list-item-action>
            ...
            <v-card>
              ...
              <v-card-text>
                <v-select
                  ...
                  item-color="success"
                  color="success"
                  :items="['Reduce weight', 'Maintain weight', 'Build muscle']"
